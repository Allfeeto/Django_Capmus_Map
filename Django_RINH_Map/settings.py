"""
Django settings for Django_RINH_Map project.
...
SECRET_KEY = 'django-insecure-))7e-y-f_jfpwuq(dfv#0ic1q0lqrrvv_t_!i^98-(_s^f)5d@'
...
ROOT_URLCONF = 'Django_RINH_Map.urls'
...
WSGI_APPLICATION = 'Django_RINH_Map.wsgi.application'
